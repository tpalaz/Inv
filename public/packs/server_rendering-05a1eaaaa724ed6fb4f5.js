      ...
      return React.createElement(
        ...
        this.state.currentPrice ? React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'subtext' },
            'Updated ' + __WEBPACK_IMPORTED_MODULE_0_moment___default()(this.state.updatedAt).fromNow()
          )
        ) : null,
        this.state.currentPrice ? React.createElement(
          'div',
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
throw new Error("Cannot find module \"moment\"");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__InfoBox__ = __webpack_require__(/*! ./InfoBox */ 7);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
      ...
      var getData = function getData() {
        ...
        fetch(url).then(function (r) {
          ...
          for (var date in bitcoinData.bpi) {
            sortedData.push({
              d: __WEBPACK_IMPORTED_MODULE_0_moment___default()(date).format('MMM DD'),
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'row' },
          !this.state.fetchingData ? React.createElement(__WEBPACK_IMPORTED_MODULE_1__InfoBox__["default"], { data: this.state.data }) : null
        ),
        React.createElement(
          'div',
          { className: 'row' },
          React.createElement(
            'div',
            { className: 'popup' },
            this.state.hoverLoc ? React.createElement(ToolTip, { hoverLoc: this.state.hoverLoc, activePoint: this.state.activePoint }) : null
          )
        ),
        React.createElement(
          'div',
          ...
          React.createElement(
            'div',
            { className: 'chart' },
            !this.state.fetchingData ? React.createElement(LineChart, { data: this.state.data, onChartHover: function onChartHover(a, b) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-05a1eaaaa724ed6fb4f5.js.map